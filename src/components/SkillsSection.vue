<template>
  <section id="skills" class="section-container pb-12 ">
      ...
      <div class="grid md:grid-cols-3 gap-8 mt-12 p-8 ">
        ...
        <div class="card reveal group shadow-md rounded-md p-6 ">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="font-display text-2xl font-semibold text-gray-800">Frontend</h3>
          </div>
          <div class="space-y-3 ">
            <div v-for="skill in frontendSkills" :key="skill.name" class="skill-item">
              <div class="flex justify-between mb-2 ">
                ...
                <span class="text-sm text-[#b76e79] font-semibold">{{ skill.level }}%</span>
              </div>
              <div class="w-full bg-gray-200 dark:bg-dark-bg rounded-full h-2 overflow-hidden">
                <div class="bg-gradient-to-r from-[#b76e79] to-pink-400 h-full rounded-full transition-all duration-1000 ease-out skill-bar"
        ...
        <div class="card reveal group shadow-md rounded-md p-6" style="animation-delay: 0.1s;">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="font-display text-2xl font-semibold text-gray-800 dark:text-gray-200">Backend</h3>
          </div>
          <div class="space-y-3">
        ...
        <div class="card reveal group shadow-md rounded-md p-6" style="animation-delay: 0.2s;">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="font-display text-2xl font-semibold text-gray-800 dark:text-gray-200">Tools & More</h3>
          </div>
          <div class="space-y-4">
            <div>
              <h4 class="font-semibold text-gray-700 dark:text-gray-300 mb-3">Development Tools</h4>
              <div class="flex flex-wrap gap-2">
                <span v-for="tool in tools" :key="tool"
                      class="px-3 py-1 bg-[#b76e79]/10 dark:bg-[#b76e79]/20 text-[#b76e79] rounded-full text-sm font-medium hover:bg-[#b76e79] hover:text-white transition-all cursor-default">
                  {{ tool }}
                </span>
              </div>
            </div>
            <div class="mt-4">
              <h4 class="font-semibold text-gray-700 dark:text-gray-300 mb-3">Soft Skills</h4>
              <div class="space-y-2">
                <div v-for="skill in softSkills" :key="skill" 
                     class="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                  <svg class="w-5 h-5 text-[#b76e79]" fill="currentColor" viewBox="0 0 20 20">
...
export default {
  ...
  data() {
    return {
      ...
      tools: ['Git', 'Oracle DB', 'VS Code', 'JSON'],
      softSkills: [
        'Analytical Thinking',
        'Team Collaboration',
        'Problem Solving',
