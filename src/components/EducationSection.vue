    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="grid md:grid-cols-3 gap-6 mt-12">
        <div v-for="(edu, index) in education" :key="index"
          ...
          <!-- Decorative Corner -->
          <div class="absolute top-0 right-0 w-20 h-20 bg-[#b76e79]/10 rounded-bl-full group-hover:scale-150 transition-transform duration-500"></div>

          <!-- Icon -->
          <div class="relative mb-6">
            <div class="w-16 h-16 bg-gradient-to-br from-[#b76e79] to-pink-400 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg">
          ...
          <!-- Institution -->
          <p class="text-[#b76e79] font-semibold mb-2">
            {{ edu.institution }}
          </p>
      ...
      <div class="mt-16 reveal">
        <h3 class="font-display text-3xl font-bold text-center mb-8 text-[#b76e79]">
          Continuous Learning
        </h3>
    ...
    return {
      ...
      certifications: [
        ...
        },
        {
          ...
          description: 'Building scalable RESTful APIs and web applications'
        },
        {
          title: 'Agile Methodologies',
          description: 'Scrum and Kanban frameworks for team collaboration'
        },
        {
          title: 'Cloud Computing Fundamentals',
          description: 'AWS and Azure cloud services and deployment'
        }
      ]
    }
  },
